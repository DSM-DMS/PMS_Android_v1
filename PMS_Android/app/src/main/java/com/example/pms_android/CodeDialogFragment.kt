 ...
 * Use the [CodeDialog_Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CodeDialog_Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CodeDialog_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CodeDialog_Fragment().apply {
